...
const TOAST_MESSAGES: Record<string, string> = {
  ...
  transfer_option_created: "Custom transfer option added.",
  transfer_option_deleted: "Custom transfer option deleted.",
  transfer_option_default_locked: "Default transfer options cannot be deleted.",
  message_updated: "Message status updated.",
  order_updated: "Order status updated.",
  order_archived: "Order archived.",
  order_unarchived: "Order moved back to active.",
  orders_archived: "Fulfilled/completed/cancelled orders archived.",
  archived_orders_cleared: "Archived orders cleared.",
  order_archive_not_eligible: "Only fulfilled, completed, or cancelled orders can be archived.",
