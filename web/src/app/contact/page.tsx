  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 py-10">
      <header className="rounded-3xl border border-rose/20 bg-white/85 p-7">
        ...
        <p className="mt-2 text-sm text-foreground/75">{content.contact.intro}</p>
      </header>
      ...
      <section className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="rounded-3xl border border-rose/20 bg-surface p-6">
          ...
          <p className="mt-1 text-sm text-foreground/75">{content.contact.phone}</p>
          <div className="mt-5 rounded-2xl bg-white p-4 text-sm text-foreground/75">
            <p className="font-semibold text-forest">{content.contact.hoursTitle}</p>
